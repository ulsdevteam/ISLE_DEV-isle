...
openssl req -x509 -nodes -days 3650 -newkey rsa:2048 -keyout ../../../config/proxy/ssl-certs/ISLEDEV.localdomain.key -out ../../../config/proxy/ssl-certs/ISLEDEV.localdomain.pem \
	-subj "/C=US/O=Islandora Collaboration Group/OU=Domain Control Validated/CN=ISLEDEV.localdomain"
