...
openssl req -x509 -nodes -days 3650 -newkey rsa:2048 -keyout ../../../config/proxy/ssl-certs/ISLEDEV.islandora-dev-01.library.pitt.edu.key -out ../../../config/proxy/ssl-certs/ISLEDEV.islandora-dev-01.library.pitt.edu.pem \
	-subj "/C=US/O=Islandora Collaboration Group/OU=Domain Control Validated/CN=ISLEDEV.islandora-dev-01.library.pitt.edu"
