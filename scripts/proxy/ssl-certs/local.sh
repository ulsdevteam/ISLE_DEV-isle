...
openssl req -x509 -nodes -days 3650 -newkey rsa:2048 -keyout ../../../config/proxy/ssl-certs/ISLE_DEV.localdomain.key -out ../../../config/proxy/ssl-certs/ISLE_DEV.localdomain.pem \
	-subj "/C=US/O=Islandora Collaboration Group/OU=Domain Control Validated/CN=ISLE_DEV.localdomain"
